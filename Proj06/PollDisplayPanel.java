...
public class PollDisplayPanel extends JPanel
{
  ...
  private void drawPieChart(Graphics g, int x, int y, int r)
  {
    ...
    if (total > 0)
    {
      ...
      drawSector(g, x, y, r, fromDegree + countToDegrees(count1, total), degrees);
      
      g.setColor(Color.BLUE);
      degrees = countToDegrees(count3, total);
      drawSector(g, x, y, r, fromDegree + countToDegrees(count1, total) + countToDegrees(count2, total), degrees);
    }
    else
    {
